function xprime = varAlTSTP(T,C,fVol,Rcnst,Temp,pCO2,...
...
AlFree = C(4)./(1 + (k1./aH) + (k2./aH.^2) + (k3./aH.^3) + (k4./aH.^4));
...
AnDissFlux = PrcntAn.*fsparM.*fsparSA.*AnDissRate.*ConversionFactor;
%
